...
public class UI {
	...
	public static void printMatch(ChessMatch match, List<ChessPiece> captureds) {
		...
		if(!match.isCheckMate()) {
			System.out.println("Waiting player " + match.getCurrentPlayer() + " move");
			if(match.isCheck()) {
				System.out.println("CHECK!");
			}
		}else {
			System.out.println("CHECK MATCH!");
			System.out.println("The " + match.getCurrentPlayer() + " Player WON!");
		}
	...
	private static void printCapturedPieces(List<ChessPiece> captureds) {
		List<ChessPiece> white = captureds.stream().filter(x -> x.getColor() == Color.WHITE)
				.collect(Collectors.toList());
		List<ChessPiece> black = captureds.stream().filter(x -> x.getColor() == Color.BLACK)
				.collect(Collectors.toList());
